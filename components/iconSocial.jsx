    ...
    return (
        <>
            <div className="flex gap-4">
                ...
                <Link href={'https://www.linkedin.com/in/iftekhermahmud1/'} target="_blank" className="size-12 glass flex justify-center items-center rounded-lg text-white 
                bg-[#0a66c2]/90
                 hover:-translate-y-1 hover:scale-105
                  transition-all duration-300 ease-in-out
                 ">
                ...
                <Link href={'https://wa.me/8801580359517?text=Hey%20there!%20I%20need%20help.'} target="_blank" className="size-12 glass flex justify-center items-center rounded-lg text-white 
                bg-[#128c7e]/90
                 hover:-translate-y-1 hover:scale-105
                  transition-all duration-300 ease-in-out
                 ">
