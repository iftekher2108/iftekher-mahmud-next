...
export default function Footer() {
  return (
  <footer className="w-full py-12 min-h-[100px] bg-gradient-to-r from-base-200 to-base-300 text-base-content text-center mt-12 rounded-t-2xl border-t border-base-200">
