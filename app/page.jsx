...
export default function Home() {
  return (
    <>
      {/* Hero Section */}
      <AnimatedSection>
        <div className="relative md:p-8 card rounded-5 shadow-md border-base-200 overflow-hidden">
          ...
          <div className="relative grid lg:grid-cols-2 gap-10 items-center z-10">
            <div className="col-span-1 p-3">
              <h1 className="text-5xl mb-4 font-extrabold text-base-content leading-tight">
                Hi, I&#39;m <span className="text-primary">Iftekher </span><span className="text-stroke text-transparent">Mahmud</span>
                <br />
                <span className="text-2xl font-bold block mt-2 text-secondary tracking-tight">Software Engineer</span>
              </h1>
            ...
            <div className="flex justify-center">
              <div className="avatar rounded-full ring-4 ring-offset-base-100 border ring-offset-4 shadow-xl flex items-center justify-center bg-white/80 ring-primary ">
